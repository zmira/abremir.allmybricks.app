...
namespace abremir.AllMyBricks.ThirdParty.Brickset.Tests.Services
{
    ...
    public class BricksetApiServiceTestsSetCollectionWants : BricksetApiServiceTestsBase
    {
...
#pragma warning restore RCS1163 // Unused parameter.
        ...
        public async Task InvalidApiKey()
        {
            ...
            var setCollectionWantsResult = await _bricksetApiService.SetCollectionWants(new ParameterSetCollectionWants());

            setCollectionWantsResult.Should()
