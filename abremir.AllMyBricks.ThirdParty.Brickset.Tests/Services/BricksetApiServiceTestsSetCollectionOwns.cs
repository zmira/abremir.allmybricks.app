...
namespace abremir.AllMyBricks.ThirdParty.Brickset.Tests.Services
{
    ...
    public class BricksetApiServiceTestsSetCollectionOwns : BricksetApiServiceTestsBase
    {
...
#pragma warning restore RCS1163 // Unused parameter.
        ...
        public async Task InvalidApiKey()
        {
            ...
            var setCollectionOwnsResult = await _bricksetApiService.SetCollectionOwns(new ParameterSetCollectionOwns());

            setCollectionOwnsResult.Should()
