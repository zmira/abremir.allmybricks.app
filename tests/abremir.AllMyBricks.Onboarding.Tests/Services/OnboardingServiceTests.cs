...
namespace abremir.AllMyBricks.Onboarding.Tests.Services
{
    ...
    public class OnboardingServiceTests
    {
        ...
        {
            _onboardingService.Get<ISecureStorageService>().GetBricksetApiKey().Returns("API KEY");
        ...
        {
            _onboardingService.Get<ISecureStorageService>().GetBricksetApiKey().Returns(string.Empty);
            _onboardingService.Get<ISecureStorageService>().IsDeviceIdentificationCreated().Returns(true);
            _onboardingService.Get<ISecureStorageService>().GetDeviceIdentification().Returns(new Shared.Models.Identification());
            _onboardingService.Get<IApiKeyService>().GetBricksetApiKey(Arg.Any<Shared.Models.Identification>()).Returns("API KEY");
        ...
        {
            _onboardingService.Get<ISecureStorageService>().GetBricksetApiKey().Returns(string.Empty);
            _onboardingService.Get<ISecureStorageService>().IsDeviceIdentificationCreated().Returns(false);
            _onboardingService.Get<IRegistrationService>().Register(Arg.Any<Shared.Models.Identification>()).Returns(new Shared.Models.Identification());
            _onboardingService.Get<IApiKeyService>().GetBricksetApiKey(Arg.Any<Shared.Models.Identification>()).Returns("API KEY");
